...
import { Plus, Filter, X, MoreHorizontal, RefreshCw, FileText } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
export const LeaveApplicationList = ({ onAddLeaveApplication, onEditLeaveApplication }: LeaveApplicationListProps) => {
  return (
    <div className="p-6">
      {/* Header */}
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Button onClick={onAddLeaveApplication} className="bg-gray-900 hover:bg-gray-800">
      ...
      <div className="mb-4 space-y-2">
        <div className="flex items-center space-x-2">
          ...
          <div className="bg-gray-100 px-3 py-1 rounded text-sm text-gray-600">Employee</div>
          <div className="bg-gray-100 px-3 py-1 rounded text-sm text-gray-600">Employee Name</div>
          <div className="bg-gray-100 px-3 py-1 rounded text-sm text-gray-600">Leave Type</div>
      ...
      <div className="bg-white rounded-lg border min-h-96 flex flex-col items-center justify-center space-y-4">
        ...
        <p className="text-gray-600 text-center">
          No Leave Application found with matching filters. Clear filters to see all Leave Application.
        </p>
        <Button 
          variant="outline" 
