      ...
      <div className="p-6">
        <Tabs defaultValue="details" className="w-full">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleInputChange("isGroup", checked as boolean)}
                  />
                ...
                <div className="space-y-2 col-span-2">
                  <Label htmlFor="defaultHolidayList">Default Holiday List</Label>
                  <Input
                    id="defaultHolidayList"
                    value={formData.defaultHolidayList}
                    onChange={(e) => handleInputChange("defaultHolidayList", e.target.value)}
                    className="bg-gray-100"
                  />
                </div>
              </div>
          ...
          <TabsContent value="accounts">
            <div className="bg-white p-6 rounded-lg border">
              <p className="text-gray-600">Accounts configuration will be added here.</p>
            </div>
          </TabsContent>

          <TabsContent value="buying">
            <div className="bg-white p-6 rounded-lg border">
              <p className="text-gray-600">Buying and selling configuration will be added here.</p>
            </div>
          </TabsContent>

          <TabsContent value="hr">
            <div className="bg-white p-6 rounded-lg border">
              <p className="text-gray-600">HR & Payroll configuration will be added here.</p>
            </div>
          </TabsContent>

          <TabsContent value="stock">
            <div className="bg-white p-6 rounded-lg border">
              <p className="text-gray-600">Stock and manufacturing configuration will be added here.</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
