...
export const LeaveApplicationForm = ({ application, onBack, onSave }: LeaveApplicationFormProps) => {
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleInputChange("halfDay", checked as boolean)}
              />
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange("followViaEmail", checked as boolean)}
                />
